...
*/
export class CorpusCustomDimension {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "indexingDefault",
            "baseName": "indexing_default",
            "type": "number"
        },
        {
            "name": "queryingDefault",
            "baseName": "querying_default",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return CorpusCustomDimension.attributeTypeMap;
    }
}
