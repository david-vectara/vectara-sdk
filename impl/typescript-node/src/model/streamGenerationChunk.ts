...
*/
export class StreamGenerationChunk {
    /**
    * When the streaming event contains the next chunk of generator output, the type will be `generation_chunk`. 
    */
    'type'?: string = 'generation_chunk';
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return StreamGenerationChunk.attributeTypeMap;
    }
}
