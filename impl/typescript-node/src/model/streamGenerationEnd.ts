...
*/
export class StreamGenerationEnd {
    /**
    * Then end of generation will be denoted with an object with the type `generation_end`. 
    */
    'type'?: string = 'generation_end';
    ...
    static getAttributeTypeMap() {
        return StreamGenerationEnd.attributeTypeMap;
    }
}
