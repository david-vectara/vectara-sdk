...
export class SearchReranker {
    /**
    * When the type is `mmr`, you can specify the `diversity_bias`, and the the retrieval engine will use the MMR reranker. 
    */
    'type'?: string = 'mmr';
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "diversityBias",
            "baseName": "diversity_bias",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return SearchReranker.attributeTypeMap;
    }
}
