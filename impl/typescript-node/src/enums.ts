...
export enum FilterAttributeLevel {
    UNDEFINED = "FILTER_ATTRIBUTE_LEVEL__UNDEFINED",
    DOCUMENT = "FILTER_ATTRIBUTE_LEVEL__DOCUMENT",  // Document - level attribute
    DOCUMENT_PART = "FILTER_ATTRIBUTE_LEVEL__DOCUMENT_PART",  // Part - level attribute
}