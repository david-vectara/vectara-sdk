...
/**
 * StructuredDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class StructuredDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StructuredDocument';
    ...
    */
    ...
    public function setSections($sections)
    {
        ...
        if ((count($sections) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sections when calling StructuredDocument., number of items must be greater than or equal to 1.');
        }
