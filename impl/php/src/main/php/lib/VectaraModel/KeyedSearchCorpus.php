...
/**
 * KeyedSearchCorpus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KeyedSearchCorpus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyedSearchCorpus';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('corpus_key', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['corpus_key'] === null) {
            $invalidProperties[] = "'corpus_key' can't be null";
        }
        if ((mb_strlen($this->container['corpus_key']) > 50)) {
            $invalidProperties[] = "invalid value for 'corpus_key', the character length must be smaller than or equal to 50.";
        }

        if (!preg_match("/[a-zA-Z0-9_\\=\\-]+$/", $this->container['corpus_key'])) {
            $invalidProperties[] = "invalid value for 'corpus_key', must be conform to the pattern /[a-zA-Z0-9_\\=\\-]+$/.";
        }
    ...
    public function setLexicalInterpolation($lexical_interpolation)
    {
        ...
        if (($lexical_interpolation > 1)) {
            throw new \InvalidArgumentException('invalid value for $lexical_interpolation when calling KeyedSearchCorpus., must be smaller than or equal to 1.');
        }
        if (($lexical_interpolation < 0)) {
            throw new \InvalidArgumentException('invalid value for $lexical_interpolation when calling KeyedSearchCorpus., must be bigger than or equal to 0.');
        }
     ...
     * @return string
     */
    public function getCorpusKey()
    {
        return $this->container['corpus_key'];
    }

    /**
     * Sets corpus_key
     *
     * @param string $corpus_key A user-provided key for a corpus.
     *
     * @return self
     */
    public function setCorpusKey($corpus_key)
    {
        if (is_null($corpus_key)) {
            throw new \InvalidArgumentException('non-nullable corpus_key cannot be null');
        }
        if ((mb_strlen($corpus_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $corpus_key when calling KeyedSearchCorpus., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/[a-zA-Z0-9_\\=\\-]+$/", ObjectSerializer::toString($corpus_key)))) {
            throw new \InvalidArgumentException("invalid value for \$corpus_key when calling KeyedSearchCorpus., must conform to the pattern /[a-zA-Z0-9_\\=\\-]+$/.");
        }

        $this->container['corpus_key'] = $corpus_key;
