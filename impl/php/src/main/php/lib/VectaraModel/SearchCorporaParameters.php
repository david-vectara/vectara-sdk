...
/**
 * SearchCorporaParameters Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchCorporaParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchCorporaParameters';
    ...
    protected static $openAPITypes = [
        ...
        'corpora' => '\OpenAPI\Client\VectaraModel\KeyedSearchCorpus[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('corpora', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['corpora'] === null) {
            $invalidProperties[] = "'corpora' can't be null";
        }
        if ((count($this->container['corpora']) < 1)) {
            $invalidProperties[] = "invalid value for 'corpora', number of items must be greater than or equal to 1.";
        }
    ...
    public function setOffset($offset)
    {
        ...
        if (($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling SearchCorporaParameters., must be bigger than or equal to 0.');
        }
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchCorporaParameters., must be bigger than or equal to 1.');
        }
     ...
     * Gets corpora
     *
     * @return \OpenAPI\Client\VectaraModel\KeyedSearchCorpus[]
     */
     ...
     * Sets corpora
     *
     * @param \OpenAPI\Client\VectaraModel\KeyedSearchCorpus[] $corpora The corpora that you want to search.
     *
     * @return self
     */
    ...
    {
        if (is_null($corpora)) {
            throw new \InvalidArgumentException('non-nullable corpora cannot be null');
        }


        if ((count($corpora) < 1)) {
            throw new \InvalidArgumentException('invalid length for $corpora when calling SearchCorporaParameters., number of items must be greater than or equal to 1.');
        }
