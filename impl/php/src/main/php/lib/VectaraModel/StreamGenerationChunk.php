...
/**
 * StreamGenerationChunk Class Doc Comment
 *
 * @category Class
 ...
 */
class StreamGenerationChunk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamGenerationChunk';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'generation_chunk');
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type When the streaming event contains the next chunk of generator output, the type will be `generation_chunk`.
     *
     * @return self
     */
