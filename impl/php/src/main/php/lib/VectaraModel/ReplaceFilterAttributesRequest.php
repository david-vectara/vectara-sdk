...
/**
 * ReplaceFilterAttributesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReplaceFilterAttributesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReplaceFilterAttributesRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['filter_attributes'] === null) {
            $invalidProperties[] = "'filter_attributes' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\VectaraModel\FilterAttribute[]
     */
     ...
     *
     * @param \OpenAPI\Client\VectaraModel\FilterAttribute[] $filter_attributes The new filter attributes.
     *
     * @return self
     */
