...
/**
 * SearchCorpus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SearchCorpus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchCorpus';
    ...
    */
    ...
    public function setLexicalInterpolation($lexical_interpolation)
    {
        ...
        if (($lexical_interpolation > 1)) {
            throw new \InvalidArgumentException('invalid value for $lexical_interpolation when calling SearchCorpus., must be smaller than or equal to 1.');
        }
        if (($lexical_interpolation < 0)) {
            throw new \InvalidArgumentException('invalid value for $lexical_interpolation when calling SearchCorpus., must be bigger than or equal to 0.');
        }
