...
/**
 * ChatInfoResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatInfoResponse';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'chat_info');
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type This will be `chat_info` when the stream event contains information about how the chat is stored.
     *
     * @return self
     */
    ...
    public function setChatId($chat_id)
    {
        ...
        if ((!preg_match("/cht_.+$/", ObjectSerializer::toString($chat_id)))) {
            throw new \InvalidArgumentException("invalid value for \$chat_id when calling ChatInfoResponse., must conform to the pattern /cht_.+$/.");
        }
    ...
    public function setTurnId($turn_id)
    {
        ...
        if ((!preg_match("/trn_.+$/", ObjectSerializer::toString($turn_id)))) {
            throw new \InvalidArgumentException("invalid value for \$turn_id when calling ChatInfoResponse., must conform to the pattern /trn_.+$/.");
        }
