...
/**
 * FactualConsistencyScore Class Doc Comment
 *
 * @category Class
 ...
 */
class FactualConsistencyScore implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FactualConsistencyScore';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'factual_consistency_score');
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type When the streaming event contains factual consistency score, the type will be `factual_consistency_score`.
     *
     * @return self
     */
