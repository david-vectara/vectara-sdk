...
/**
 * StreamSearchResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class StreamSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamSearchResponse';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'search_results');
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type When the streaming event has the search results, the type will be `search_results`.
     *
     * @return self
     */
