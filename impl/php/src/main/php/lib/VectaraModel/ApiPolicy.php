 ...
 */
class ApiPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiPolicy';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'allowed_operations' => 'array<string,\OpenAPI\Client\VectaraModel\ApiOperationPolicy>'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the API role.
     *
     * @return self
     */
     ...
     *
     * @return array<string,\OpenAPI\Client\VectaraModel\ApiOperationPolicy>
     */
