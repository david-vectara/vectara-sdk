...
/**
 * CoreDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class CoreDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CoreDocument';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'core');
    ...
    */
     ...
     * Sets type
     *
     * @param string $type When the type of the indexed document is `core` the rest of the object is expected to follow this schema. This schema allows precise specification of document chunks that get directly translated to retrieval search results.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata Arbitrary object of document level metadata. Properties of this object can be used by document filter if defined as a corpus filter attribute.
     *
     * @return self
     */
    ...
    public function setDocumentParts($document_parts)
    {
        ...
        if ((count($document_parts) < 1)) {
            throw new \InvalidArgumentException('invalid length for $document_parts when calling CoreDocument., number of items must be greater than or equal to 1.');
        }
