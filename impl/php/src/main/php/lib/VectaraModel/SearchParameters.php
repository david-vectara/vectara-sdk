...
class SearchParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setOffset($offset)
    {
        ...
        if (($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling SearchParameters., must be bigger than or equal to 0.');
        }
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SearchParameters., must be bigger than or equal to 1.');
        }
