...
/**
 * CoreDocumentPart Class Doc Comment
 *
 * @category Class
 ...
 */
class CoreDocumentPart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CoreDocumentPart';
    ...
    */
     ...
     * Sets text
     *
     * @param string $text The text of the document part.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata The metadata for a document part. Attributes matching corpus document part filter attributes are used as document part filter attributes.
     *
     * @return self
     */
     ...
     * Sets context
     *
     * @param string|null $context The context text for the document part.
     *
     * @return self
     */
