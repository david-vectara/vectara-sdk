 ...
 */
class Corpus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Corpus';
    ...
    protected static $openAPITypes = [
        ...
        'limits' => '\OpenAPI\Client\VectaraModel\CorpusLimits',
        'created_at' => '\DateTime'
    ];
    ...
    protected static $attributeMap = [
        ...
        'enabled' => 'enabled',
        'chat_history_corpus' => 'chat_history_corpus',
    ...
    protected static $setters = [
        ...
        'enabled' => 'setEnabled',
        'chat_history_corpus' => 'setChatHistoryCorpus',
    ...
    protected static $getters = [
        ...
        'enabled' => 'getEnabled',
        'chat_history_corpus' => 'getChatHistoryCorpus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('chat_history_corpus', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && !preg_match("/crp_[0-9]+$/", $this->container['id'])) {
            $invalidProperties[] = "invalid value for 'id', must be conform to the pattern /crp_[0-9]+$/.";
        }
        ...
        if (!is_null($this->container['key']) && !preg_match("/[a-zA-Z0-9_\\=\\-]+$/", $this->container['key'])) {
     ...
     * Sets id
     *
     * @param string|null $id Vectara ID of the corpus.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((!preg_match("/crp_[0-9]+$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling Corpus., must conform to the pattern /crp_[0-9]+$/.");
        }
     ...
     * Sets key
     *
     * @param string|null $key A user-provided key for a corpus.
     *
     * @return self
     */
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $key when calling Corpus., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/[a-zA-Z0-9_\\=\\-]+$/", ObjectSerializer::toString($key)))) {
            throw new \InvalidArgumentException("invalid value for \$key when calling Corpus., must conform to the pattern /[a-zA-Z0-9_\\=\\-]+$/.");
        }
     ...
     * Sets name
     *
     * @param string|null $name Name for the corpus. This value defaults to the key.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Corpus description.
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Specifies whether the corpus is enabled or not.
     *
     * @return self
     */
    ...
    /**
     * Gets chat_history_corpus
     *
     * @return bool|null
     */
    public function getChatHistoryCorpus()
    {
        return $this->container['chat_history_corpus'];
    }

    /**
     * Sets chat_history_corpus
     *
     * @param bool|null $chat_history_corpus Indicates that this corpus does not store documents amd stores chats instead.
     *
     * @return self
     */
    public function setChatHistoryCorpus($chat_history_corpus)
    {
        if (is_null($chat_history_corpus)) {
            throw new \InvalidArgumentException('non-nullable chat_history_corpus cannot be null');
        }
        $this->container['chat_history_corpus'] = $chat_history_corpus;
     ...
     *
     * @param bool|null $queries_are_answers Queries made to this corpus are considered answers, and not questions. This swaps the semantics of the encoder used at query time.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $documents_are_questions Documents inside this corpus are considered questions, and not answers. This swaps the semantics of the encoder used at indexing.
     *
     * @return self
     */
     ...
     * Sets encoder_id
     *
     * @param string|null $encoder_id The encoder used by the corpus.
     *
     * @return self
     */
    public function setEncoderId($encoder_id)
    {
        ...
        if ((!preg_match("/enc_[0-9]+$/", ObjectSerializer::toString($encoder_id)))) {
            throw new \InvalidArgumentException("invalid value for \$encoder_id when calling Corpus., must conform to the pattern /enc_[0-9]+$/.");
        }
     ...
     *
     * @param \OpenAPI\Client\VectaraModel\FilterAttribute[]|null $filter_attributes The new filter attributes of the corpus.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\VectaraModel\CorpusCustomDimension[]|null $custom_dimensions The custom dimensions of all document parts inside the corpus.
     *
     * @return self
     */
     ...
     * Gets limits
     *
     * @return \OpenAPI\Client\VectaraModel\CorpusLimits|null
     */
     ...
     * Sets limits
     *
     * @param \OpenAPI\Client\VectaraModel\CorpusLimits|null $limits limits
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Indicates when the corpus was created.
     *
     * @return self
     */
